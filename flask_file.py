    ...
    if request.method == 'POST':
        if ('file' in request.files):
            ...
            if choice=="view":
                ...
                name, chat_data, no_of_users = main.chat_generator(file.read(), filename)
                first_user, second_user = profile_generator(name, no_of_users)
                html = render_template('chat_box.html', name = name, chat = chat_data, first = first_user, second = second_user, color_code = configuration.color_code_dict)
...
#    html.Div(children='Number of chats based on date', style={
#        'textAlign': 'center',
#        'color': colors['text']
#    }),
